...
public class ArcherController : BaseController, IReceiveAttack
{
    ...
    {
        //상태 생성
        ArcherMoveState MoveState = new ArcherMoveState(this, rigidBody, animator);
        ArcherAttackState AttackState = new ArcherAttackState(this, rigidBody, animator, weapon);
