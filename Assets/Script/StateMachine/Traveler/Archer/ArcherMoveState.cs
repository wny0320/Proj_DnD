...
public class ArcherMoveState : BaseState
{
    ...
    public ArcherMoveState(BaseController controller, Rigidbody rb = null, Animator animator = null) : base(controller, rb, animator)
    {
    ...
    private void Flee()
    {
        ...
        if ((transform.position - fleePos).magnitude <= 2f)
        {
            fleePos = Vector3.zero;
            randomPos = Vector3.zero;
        }
