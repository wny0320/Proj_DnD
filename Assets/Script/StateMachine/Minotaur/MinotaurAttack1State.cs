...
public class MinotaurAttack1State : BaseState
{
    EnemyWeapon weapon;
    bool isComboAttack = true;

    //적 공격 후, 다시 movestate로 변경
    public MinotaurAttack1State(BaseController controller, Rigidbody rb = null, Animator animator = null, EnemyWeapon weapon = null) : base(controller, rb, animator)
    {
        this.weapon = weapon;
    }
